...
import { BulkImportRecurringSchedule } from "@/components/schedule/bulk-import-recurring";
import Link from "next/link";

export const dynamic = "force-dynamic";

export default async function ImportRecurringSchedulePage() {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <BulkImportRecurringSchedule locations={locations} instructors={instructors} />
    </div>
  );
}
