    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-white p-4 space-y-3">
        ...
        <div className="text-sm text-muted-foreground space-y-1">
          ...
          <p>
            <strong>עמודות אופציונליות:</strong> מדריך/ה משובץ/ת, כתובת, גננת/רכזת, איש קשר, קב&apos;, מסגרת,
            שם המסגרת, חוג, משך שיעור, תאריך התחלה, הערות
          </p>
          <p>
            אפשר להוסיף שורה ללוח הקבוע גם בלי מדריך/ה משובץ/ת (למשל כשעדיין לא ידוע מי ילמד) — היא תיווצר
            &quot;ללא מדריך&quot; וניתן לשבץ מדריך/ה אליה מאוחר יותר, מהלוח הקבוע עצמו.
          </p>
          <p>
