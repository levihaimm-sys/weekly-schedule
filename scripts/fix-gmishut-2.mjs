...
async function fixLesson() {
  const pdfPath = 'Lessons/5 - גמישות והתעמלות קרקע, ריקוד ונופש פעיל/מערך 2 - גמישות, תנועה ונופש פעיל.pdf';
  ...
  if (data) {
    ...
    console.log('✅ תיקנתי את גמישות תנועה 2!');
  }
}
